	 ...
	 */
		...
		$wp_customize->add_setting( 'hdr_top_icon_menu', 
			array(
			 ...
			 'priority' => 2,
			 'default' => instashare_get_icon_menu_default()
			)
		);
		...
		$wp_customize->add_control( 
			new Instashare_Repeater( $wp_customize, 
				'hdr_top_icon_menu', 
					array(
						'label'   => esc_html__('Icon Menu','neph-soft'),
						'section' => 'above_header',
						'add_field_label'                   => esc_html__( 'Add New Menus', 'neph-soft' ),
						'item_name'                         => esc_html__( 'Menus', 'neph-soft' ),
...
function instashare_lite_header_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'tlh_help_title', array(
		...
		'render_callback'  => 'instashare_tlh_mobile_title_render_callback',
	) );
	...
	$wp_customize->selective_refresh->add_partial( 'tlh_settings_title', array(
		...
		'render_callback'  => 'instashare_tlh_email_title_render_callback',
	) );
...
add_action( 'customize_register', 'instashare_lite_header_partials' );
