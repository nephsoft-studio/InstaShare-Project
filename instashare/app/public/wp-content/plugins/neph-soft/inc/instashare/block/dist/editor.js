 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "instashareInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .instashareInfos .instashareInfo .title{\n                        ")
                                .concat(O, " .instashareInfos .instashareInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
                        { className: "instashare"},
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "instashareIconTitle ".concat(n) },
                    ...
                    wp.element.createElement(
                        "div",
                        { className: "instashareIconSelect" },
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        f &&
                            ...
                            wp.element.createElement(
                                t.PanelBody,
                                { title: (0, e.__)("Link Settings", "neph-soft"), initialOpen: !1 },
                                wp.element.createElement(l, { mt: "0" }, (0, e.__)("Link:", "neph-soft")),
							...
							wp.element.createElement(
                                t.PanelBody,
                                { title: (0, e.__)("Layout Settings", "neph-soft"), initialOpen: !1 },
                                wp.element.createElement(l, { mt: "0" }, (0, e.__)("Columns:", "neph-soft")),
							...
							k &&
								wp.element.createElement(
									t.PanelBody,
									{ title: (0, e.__)("Info Type", "neph-soft"), initialOpen: !1 },
									wp.element.createElement(l, { mt: "0" }, (0, e.__)("Info Type:", "neph-soft")),
									wp.element.createElement(t.TextControl, {
										value: w,
										onChange: function (a) {
											return C({ infoType: a });
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "instashareInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #instashareInfo-"
                                    .concat(x, " .instashareInfo .bgLayer{\n                    ")
                                    .concat(x, " .instashareInfo .title{\n                    color: ")
                                    .concat(x, " .instashareInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #instashareInfo-")
                                    .concat(x, " .instashareInfo .description{\n                    color: ")
                                    .concat(x, " .instashareInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "instashareInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".instashareInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".instashareInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
