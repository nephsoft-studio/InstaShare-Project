(function ($) {
    'use strict';
    wp.instasharecustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                instashare_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.instasharecustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.instasharecustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.instasharecustomizerRepeater.iconPickerToggle($(this));
        });
