...
?>
<?php
function instashare_repeater_register( $wp_customize ) {

	require_once( get_template_directory().'/inc/customizer-repeater/class/customizer-repeater-control.php' );
	
}
add_action( 'customize_register', 'instashare_repeater_register' );

function instashare_repeater_sanitize($input){
