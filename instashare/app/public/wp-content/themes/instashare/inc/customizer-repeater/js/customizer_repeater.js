/* global jQuery */
/* global wp */
function instashare_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function instashare_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function instashare_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + instashare_customizer_repeater_uniqid();
    ...
    instashare_customizer_repeater_refresh_general_control_values();
}


function instashare_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + instashare_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== ''  || image_url2 !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': instashareescapeHtml(text),
                    'link': link,
                    'text2': instashareescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
					'image_url2': image_url2,
                    'title': instashareescapeHtml(title),
                    'subtitle': instashareescapeHtml(subtitle),
					'subtitle2': instashareescapeHtml(subtitle2),
					'subtitle3': instashareescapeHtml(subtitle3),
					'subtitle4': instashareescapeHtml(subtitle4),
					'subtitle5': instashareescapeHtml(subtitle5),
					'slide_align': instashareescapeHtml(slide_align),
                    'social_repeater': instashareescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': instashareescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var instashare_theme_controls = jQuery('#customize-theme-controls');
    instashare_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    instashare_theme_controls.on('change', '.icp',function(){
        instashare_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	instashare_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		instashare_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
	instashare_theme_controls.on('change','.customizer-repeater-image2-control', function(){
		instashare_customizer_repeater_refresh_general_control_values();
        return false;
    ...
    instashare_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    instashare_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    instashare_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + instashare_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Slid")
        {
        if(jQuery('#exist_instashare_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Slider').val())+1;
         jQuery('#exist_instashare_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_instashare_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Service').val())+1;
         jQuery('#exist_instashare_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Cont")
        {
        if(jQuery('#exist_instashare_Content').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Content').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Content').val())+1;
         jQuery('#exist_instashare_Content').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Social")
        {
        if(jQuery('#exist_instashare_Social').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Social').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Social').val())+1;
         jQuery('#exist_instashare_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Menu")
        {
        if(jQuery('#exist_instashare_Menus').val()>=2)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Menus').val()<2)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Menus').val())+1;
         jQuery('#exist_instashare_Menus').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Clie")
        {
        if(jQuery('#exist_instashare_Client').val()>=5)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_instashare_Client').val()<5)
        {
         var new_service_add_val=parseInt(jQuery('#exist_instashare_Client').val())+1;
         jQuery('#exist_instashare_Client').val(new_service_add_val);  
        }
        }
    ...
    instashare_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_instashare_Slider').val(parseInt(jQuery('#exist_instashare_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_instashare_Service').val(parseInt(jQuery('#exist_instashare_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Conte")
                {
                jQuery('#exist_instashare_Content').val(parseInt(jQuery('#exist_instashare_Content').val())-1); 
                }
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_instashare_Social').val(parseInt(jQuery('#exist_instashare_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Menus")
                {
                jQuery('#exist_instashare_Menus').val(parseInt(jQuery('#exist_instashare_Menus').val())-1); 
                }
				if(split_delete_button_split=="Delete Clien")
                {
                jQuery('#exist_instashare_Client').val(parseInt(jQuery('#exist_instashare_Client').val())-1); 
                }
    ...
    instashare_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
    ...
    instashare_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
	
	 instashare_theme_controls.on('keyup', '.customizer-repeater-subtitle2-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
	
	instashare_theme_controls.on('keyup', '.customizer-repeater-subtitle3-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
	
	instashare_theme_controls.on('keyup', '.customizer-repeater-subtitle4-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
	
	instashare_theme_controls.on('keyup', '.customizer-repeater-subtitle5-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        instashare_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    instashare_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + instashare_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    instashare_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        instashare_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    instashare_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        instashare_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    instashare_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function instashareescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return instashareentityMap[s];
    });
