 ...
 */
function instashare_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function instashare_sanitize_html( $html ) {
 ...
 */
function instashare_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function instashare_sanitize_range_value( $number, $setting ) {
 ...
 */
function instashare_sanitize_select( $input, $setting ) {
 ...
 */
function instashare_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function instashare_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function instashare_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}